...
public class DrawerBlurActionBarDrawerToggle extends ActionBarDrawerToggle {
    ...
    /**
     * DrawerBlur radius used for the background.
     */
    private int mBlurRadius = DEFAULT_BLUR_RADIUS;

    /**
     * Default DrawerBlur Radius
     */
    ...
    public DrawerBlurActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
    ...
    public DrawerBlurActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
    ...
    private void render() {
        ...
        if (prepareToRender) {
            ...
            bitmap = DrawerBlur.fastblur(context, bitmap, mBlurRadius, false);
