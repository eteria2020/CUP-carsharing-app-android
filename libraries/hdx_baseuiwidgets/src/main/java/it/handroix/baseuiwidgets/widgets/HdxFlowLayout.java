...
/**
 * Created by andrealucibello on 10/12/13.
 */
public class HdxFlowLayout extends ViewGroup {
        ...
        public HdxFlowLayout(Context context) {
            super(context);

            this.readStyleParameters(context, null);
        }

        public HdxFlowLayout(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);

            this.readStyleParameters(context, attributeSet);
        }

        public HdxFlowLayout(Context context, AttributeSet attributeSet, int defStyle) {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.HdxFlowLayout);
            try {
                horizontalSpacing = a.getDimensionPixelSize(R.styleable.HdxFlowLayout_horizontalSpacing, 0);
                verticalSpacing = a.getDimensionPixelSize(R.styleable.HdxFlowLayout_verticalSpacing, 0);
                orientation = a.getInteger(R.styleable.HdxFlowLayout_orientation, HORIZONTAL);
                debugDraw = a.getBoolean(R.styleable.HdxFlowLayout_debugDraw, false);
            } finally {
                a.recycle();
            }
        }
        ...
        public static class LayoutParams extends ViewGroup.LayoutParams {
            ...
            private void readStyleParameters(Context context, AttributeSet attributeSet) {
                TypedArray a = context.obtainStyledAttributes(attributeSet, R.styleable.HdxFlowLayout_LayoutParams);
                try {
                    horizontalSpacing = a.getDimensionPixelSize(R.styleable.HdxFlowLayout_LayoutParams_layout_horizontalSpacing, NO_SPACING);
                    verticalSpacing = a.getDimensionPixelSize(R.styleable.HdxFlowLayout_LayoutParams_layout_verticalSpacing, NO_SPACING);
                    newLine = a.getBoolean(R.styleable.HdxFlowLayout_LayoutParams_layout_newLine, false);
                } finally {
                    a.recycle();
                }
            }
